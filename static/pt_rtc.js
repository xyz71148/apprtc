...
Call.prototype.getLeaveUrl_ = function() {
  return this.roomServer_ + "/api/rtc/room/leave/" + this.params_.roomId + "/" + this.params_.clientId;
};
...
Call.prototype.connectToRoom_ = function(roomId) {
  ...
  var joinPromise = this.joinRoom_().then(function(roomParams) {
    ...
    this.params_.roomLink = `${location.origin}${location.pathname}` +roomParams.room_link;
...
Call.prototype.joinRoom_ = function() {
  return new Promise(function(resolve, reject) {
    ...
    var path = this.roomServer_ + "/api/rtc/room/join/" + this.params_.roomId + window.location.search;
...
Call.prototype.sendSignalingMessage_ = function(message) {
  ...
  if (this.params_.isInitiator) {
    var path = this.roomServer_ + "/api/rtc/message/" + this.params_.roomId + "/" + this.params_.clientId + window.location.search;
